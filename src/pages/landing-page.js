    ...
    <nav className="lp__container lp__navbar">
      <div class="lp__navbar__container">
        ...
        <div className="lp__btns">
          <Link to="login" className="lp__btn--secondary">
            Login
          </Link>
    ...
    <header className="lp__container lp__header">
      <div class="lp__header__container">
        <div className="lp__header__col--1">
          ...
          <p>
            Crie produtos e serviços digitais como e-books, cursos
            online,mentorias — e venda com a menor taxa do mercado.
          </p>
          <Link to="create-account" className="btn--primary">
            Cadastre-se agora
          </Link>
      ...
      <div className="lp__container">
        <div className="lp__guides__container">
          ...
          <div className="lp__guides__col--2">
            <h2>
              Sua primeira venda no digital mais rápida do que você imagina
            </h2>
            <div>
              <h3>Cadastro de conta:</h3>
              <p>
                Clique no botão "Cadastre-se". Insira as informações solicitadas
                e siga o fluxo de boas-vindas.
              </p>
      ...
      <div className="lp__container">
        <div className="lp__business__container">
          <div className="lp__business__text">
            ...
            <p>
              Promova produtos de terceiros através de links de afiliaçãoe
              receba uma comissão por cada venda realizada.
            </p>
          </div>
          <img src={businessImg} />
        </div>
      ...
      <div className="lp__container">
        <div className="lp__contact__container">
          <div className="lp__contact__col--1">
            ...
            <p>
              Evite que seu cliente esqueça de pagar em dia, nosso recuperador
              envia mensagens relevantes para os seus clientes, o que aumenta as
