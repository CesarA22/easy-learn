    ...
    <div className="product-details-container">
      ...
      <main className="main-content">
        <header>
          ...
          {isEditing ? (
            <button onClick={handleSave} className='edit-button'>Salvar</button>
          ) : (
          ...
          {isEditing ? (
            ...
            <>
              <div className="product-images">
                {product.images && product.images.length > 0 ? (
                  product.images.map((image, index) => (
                    <img key={index} src={`http://localhost:3000${image}`} alt={`Imagem ${index + 1}`} />
                  ))
                ) : (
              ...
              <div className="product-info">
                ...
                <p><strong>Conteúdo:</strong> {product.content}</p>
